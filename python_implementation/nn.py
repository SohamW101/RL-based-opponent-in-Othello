...
def train_nn(X_train, Y_train, W1, b1, W2, b2, epochs, learning_rate):
...
for i in range(100):  
    sample = []
    for j in range(36):
        sample.append(random.uniform(-1, 1))
...
W1, b1, W2, b2 = initialize_nn(36, 44, 36)

W1, b1, W2, b2 = train_nn(X_train, Y_train, W1, b1, W2, b2, epochs=1000, learning_rate=0.01)
